          ...
          <Section>
            <div className="flex flex-wrap justify-between items-center w-full">
              ...
              <div className="hidden lg:flex items-center flex-1 justify-between ml-12">
                ...
                {/* Auth Buttons */}
                {!mounted ? (
                  // Show login button during SSR/initial render
                  ...
                  <div className="flex items-center space-x-4">
                    <button
                      onClick={() => setIsModalOpen(true)}
                      disabled={isLoading}
                      className="text-gray-900 bg-yellow-400 hover:bg-yellow-500 px-5 py-2.5 rounded-full text-sm font-medium border border-white transition-all duration-200 hover:shadow-lg hover:shadow-yellow-500/20 disabled:opacity-75 disabled:cursor-not-allowed"
                    >
                      {isLoading ? (
                  ...
                  <div className="flex justify-center items-center">
                    <div className="flex bg-white items-center w-10 h-10 border-2 p-1 border-gray-500 rounded-full space-x-2">
