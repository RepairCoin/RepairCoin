const CustomerIcon = ({ width, height }: any) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      <circle cx="12" cy="9" r="4" fill="white" fillOpacity="0.8" />
      <circle cx="17" cy="9" r="3" fill="white" fillOpacity="0.8" />
      <circle cx="7" cy="9" r="3" fill="white" fillOpacity="0.8" />
      <path
