const BuyRcnIcon = ({ width, height, isActive }: any) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="17" cy="20" r="1" fill={isActive ? '#000000' : 'white'} fillOpacity="0.8" />
      <circle cx="9" cy="20" r="1" fill={isActive ? '#000000' : 'white'} fillOpacity="0.8" />
    </svg>
  );
};

export default BuyRcnIcon;
