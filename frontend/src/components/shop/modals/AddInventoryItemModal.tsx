// frontend/src/components/shop/modals/AddInventoryItemModal.tsx
...
export const AddInventoryItemModal: React.FC<AddInventoryItemModalProps> = ({ onClose, onSuccess }) => {
  // Form state
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-800">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Create a new item in your inventory</p>
            </div>
          </div>
          <button
            onClick={onClose}
