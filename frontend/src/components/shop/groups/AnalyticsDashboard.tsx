...
export default function AnalyticsDashboard({ groupId }: AnalyticsDashboardProps) {
  ...
  const stats = [
    { label: "Tokens Circulating", value: analytics.totalTokensCirculating.toLocaleString(), icon: Coins },
    { label: "Total Issued", value: analytics.totalTokensIssued.toLocaleString(), icon: ArrowUpRight },
    { label: "Total Redeemed", value: analytics.totalTokensRedeemed.toLocaleString(), icon: ArrowDownRight },
    { label: "Active Members", value: analytics.activeMembers.toString(), icon: Users },
    { label: "Unique Member", value: analytics.uniqueCustomers.toString(), icon: Users },
    { label: "Total Transactions", value: analytics.totalTransactions.toLocaleString(), icon: BarChart3 },
    { label: "Avg Transaction Size", value: analytics.averageTransactionSize.toFixed(2), icon: BarChart3 },
    { label: "Issued (Last 30 Days)", value: analytics.tokensIssuedLast30Days.toLocaleString(), icon: Clock },
    { label: "Redeemed (Last 30 Days)", value: analytics.tokensRedeemedLast30Days.toLocaleString(), icon: Clock },
  ];
