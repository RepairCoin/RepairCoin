...
const BalanceAlertCard: React.FC<{ balance: number }> = ({ balance }) => {
  return (
    <div className="bg-gray-800 bg-opacity-90 rounded-lg border border-gray-700 p-6">
      <h3 className="text-lg font-bold text-yellow-400 mb-4">Balance Alert</h3>
      <div className="space-y-3">
        {balance < 50 ? (
          <div className="bg-red-900 bg-opacity-50 border border-red-700 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="text-sm font-medium text-red-300">Low Balance</h4>
          ...
          <div className="bg-green-900 bg-opacity-50 border border-green-700 rounded-lg p-4">
            <div className="flex items-center">
              ...
              <div>
                <h4 className="text-sm font-medium text-green-300">Healthy Balance</h4>
