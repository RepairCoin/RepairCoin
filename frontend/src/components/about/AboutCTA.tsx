      ...
      <div className="max-w-3xl mx-auto px-4 lg:px-8 relative z-10 text-center space-y-6 sm:space-y-8">
        <AnimateOnScroll>
          <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold text-white leading-tight">
            ...
            <span className="relative inline-block">
              FixFlow AI?
              <svg
                className="absolute -bottom-4 left-0 w-full h-[18px]"
                viewBox="0 0 311 8"
                fill="none"
        ...
        <AnimateOnScroll delay={0.3}>
          <p className="text-gray-400 text-base sm:text-lg max-w-xl mx-auto pt-2 sm:pt-4">
            Join businesses using AI-powered tools to simplify operations, strengthen customer
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6 sm:mt-8">
            ...
            <Link
              href="/features"
              className="bg-white hover:bg-gray-100 text-black font-semibold px-8 sm:px-10 py-3.5 sm:py-4 rounded-lg transition-all duration-200 text-base sm:text-lg"
            >
              Explore Features →
            </Link>
          </div>
