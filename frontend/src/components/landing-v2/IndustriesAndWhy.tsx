    ...
    <>
      ...
      <section className="relative bg-[#191919] py-12 sm:py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          ...
          {/* Industry Pills */}
          <StaggerContainer className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto">
            {industries.map((industry) => (
              <m.div
                ...
                whileTap={{ scale: 0.97 }}
                className="flex items-center gap-2 sm:gap-3 px-3 sm:px-5 py-3 sm:py-3.5 bg-gradient-to-br from-[#1a1a1a] to-[#0e0e0e] rounded-xl border border-gray-700/50 card-hover-glow cursor-pointer"
              >
