          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-6 lg:gap-8 items-center">
            ...
            <div className="space-y-4 sm:space-y-7 pt-20 sm:pt-28 lg:pt-0 pb-8 md:pb-0">
              ...
              >
                ...
                <br />
                <span className="sm:whitespace-nowrap"><span className="text-gold-gradient">Grow</span> Your Business.</span>
              </m.h1>
            ...
            <div className="relative hidden lg:block h-[550px] xl:h-[600px]">
              <m.div
                ...
                transition={prefersReducedMotion ? undefined : { duration: 0.8, delay: 0.4, ease: "easeOut" as const }}
              ...
              <m.div
                ...
                animate={prefersReducedMotion ? undefined : { opacity: 1, y: 0 }}
                transition={prefersReducedMotion ? undefined : { duration: 0.8, delay: 0.6, ease: "easeOut" as const }}
            ...
            <div className="relative flex lg:hidden flex-col items-center pb-6">
              <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md h-[280px] sm:h-[320px] md:h-[350px]">
                ...
                <m.div
                  {...fadeUp(0.4)}
                  className="absolute right-0 top-0 w-[75%] h-[60%] hidden md:block"
                >
                  <Image
                    src="/img/landingv2/MacBookAir.png"
                    alt="RepairCoin Dashboard on MacBook"
                ...
                <m.div
                  {...fadeUp(0.5)}
                  className="relative md:absolute mx-auto md:mx-0 md:left-[5%] md:bottom-0 w-[140px] sm:w-[160px] md:w-[38%] h-[260px] sm:h-[300px] md:h-[80%] z-10"
                >
                  <Image
                    src="/img/landingv2/iPhone13.png"
                    alt="RepairCoin Mobile App"
              ...
              <m.div {...fadeUp(0.5)} className="mt-4 sm:hidden">
                <button
                  onClick={handleGetStartedClick}
                  disabled={isLoading}
