...
const tierShopData: TierData[] = [
  {
    ...
    features: [
      ...
      "Automated tier bonuses (+0/+2/+5 RCN)",
      "Real-time dashboard with QR scanning",
      "Join the universal redemption network",
...
const tierCustomerData: TierData[] = [
  {
    ...
    features: [
      ...
      "Tier-based bonuses on every transaction",
      "$1 redemption value at any shop",
      "100% balance usable at all shops",
