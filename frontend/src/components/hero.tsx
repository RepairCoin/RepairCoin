...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    ...
    >
      <Section>
        <div className='flex flex-col border-2 border-white mb-36'>
          <div className='w-3/7 border-2 border-white py-2'>
          ...
          <div className='flex flex-row gap-6 border-2 border-white pt-20'>
