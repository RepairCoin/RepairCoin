  ...
  return (
    <div className="text-white">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Filters - Show at the top, hide when showing favorites or map view or on shops tab */}
        {activeTab === "services" && !showFavoritesOnly && viewMode === "grid" && (
          <div className="mb-8">
            <ServiceFilters
              filters={filters}
              ...
              <div className="mb-8">
                <div className="bg-gradient-to-r from-purple-900/20 to-purple-800/20 border border-purple-500/30 rounded-xl p-5">
                  ...
                  <select
                    ...
                    className="w-full px-4 py-3 bg-gray-800 border border-purple-500/50 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 appearance-none bg-[url('data:image/svg+xml;charset=UTF-8,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20width%3D%2224%22%20height%3D%2224%22%20viewBox%3D%220%200%2024%2024%22%20fill%3D%22none%22%20stroke%3D%22%239ca3af%22%20stroke-width%3D%222%22%20stroke-linecap%3D%22round%22%20stroke-linejoin%3D%22round%22%3E%3Cpolyline%20points%3D%226%209%2012%2015%2018%209%22%3E%3C%2Fpolyline%3E%3C%2Fsvg%3E')] bg-[length:20px] bg-[right_12px_center] bg-no-repeat pr-10 hover:border-purple-400/70 cursor-pointer transition-colors"
                  >
