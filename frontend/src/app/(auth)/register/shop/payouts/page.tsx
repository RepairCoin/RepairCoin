...
export default function ShopPayoutsPage() {
  ...
  // Open the embedded "Get Paid" onboarding in-app — no redirect to Stripe.
  ...
  return (
    <div className="min-h-screen bg-[#191919] pb-24 pt-28 md:pt-32">
      <div className="mx-auto w-full max-w-[880px] space-y-6 px-6">
        ...
        <ProgressPanel step={5} label="Set Up Payments" />

        <div className={PANEL}>
          <h1 className="text-lg font-bold text-[#FFCC00]">
            Get Paid with FixFlow Payments
          </h1>
          <p className="mt-2 text-sm text-[#999999]">
            Set up payments to securely receive customer payments and payouts — all inside
            FixFlow. Your details are verified by Stripe; FixFlow never stores your banking
            information.
          </p>

          {showOnboarding ? (
            <div className="mt-6 rounded-xl border border-white/10 bg-[#1D1D1D] p-4 sm:p-6">
              <GetPaidOnboarding
                onExit={() => {
            ...
            <>
              {pending && (
                <p className="mt-4 rounded-md border border-[#FFCC00]/30 bg-[#FFCC00]/[0.08] p-3 text-sm text-white">
                  {needsInfo
                    ? "A few more details are needed before payments can be enabled — pick up where you left off below."
                    : underReview
                    ? "Your details are being reviewed. This usually takes a few hours, and can take up to two business days. You can leave this page — payouts turn on automatically once your account is approved."
                    : "Your details are submitted and awaiting confirmation. You can safely leave this page and come back."}
                </p>
              )}
              ...
              <div className="mt-8 text-center">
                {!underReview && (
                  <>
                    ...
                    <p className="mx-auto mt-3 max-w-[420px] text-xs leading-relaxed text-[#999999]">
                      Complete your payment setup securely inside FixFlow — no need to visit
                      Stripe. FixFlow never stores your banking information.
                    </p>
                  </>
                )}
                ...
                {underReview && (
                  <p className="mx-auto max-w-[420px] text-xs leading-relaxed text-[#999999]">
                    Nothing more is needed from you right now. Payouts turn on automatically
                    once your details finish being reviewed.
                  </p>
                )}
