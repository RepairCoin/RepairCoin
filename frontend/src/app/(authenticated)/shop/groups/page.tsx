  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0D0D0D]">
      <div className="text-center">
        ...
        <p className="mt-4 text-white">Loading affiliate shop groups...</p>
      </div>
    </div>
  );
}

export default function AffiliateShopGroupsPage() {
  console.log("📄 AffiliateShopGroupsPage rendering");
  return (
