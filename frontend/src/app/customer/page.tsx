                ...
                <defs>
                  ...
                  >
                    ...
                    <feBlend
                      mode="normal"
                      in2="BackgroundImageFix"
                      result="effect1_dropShadow_2775_3834"
                    />
                    <feBlend
                      mode="normal"
                      in="SourceGraphic"
                      in2="effect1_dropShadow_2775_3834"
                      result="shape"
                    />
                  </filter>
                </defs>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="rounded-2xl p-6">
              ...
              <p className="text-gray-300 text-sm tracking-wide">
                Earn 25 RCN for each successful referral. New customers get 10
                RCN bonus. No limit on referrals.
              </p>
            </div>
