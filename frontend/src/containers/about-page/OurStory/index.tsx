        ...
        <div className="w-full flex gap-14 justify-between items-center py-8 xl:py-20">
          ...
          <div className="w-full lg:w-1/3 space-y-6">
            ...
            <div className="space-y-4 text-gray-300">
              <p>
                As a repair shop owner, I noticed something missing— customers
                were happy with the fix, but there was no lasting connection. I
              ...
              <p>
                ...
                —a way to reward every repair and build loyalty through real
                value. Now, every device fixed earns crypto, turning everyday
                repairs into something bigger: a movement that supports both
                customers and local shops.
              </p>
            </div>
          </div>
