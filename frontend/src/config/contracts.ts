...
// Contract addresses
export const RCN_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RCN_CONTRACT_ADDRESS || process.env.NEXT_PUBLIC_CONTRACT_ADDRESS || "0xBFE793d78B6B83859b528F191bd6F2b8555D951C";
export const RCG_CONTRACT_ADDRESS = process.env.NEXT_PUBLIC_RCG_CONTRACT_ADDRESS || "0x973D8b27E7CD72270F9C07d94381f522bC9D4304";
