 ...
 *
 * @example
 * // User in UTC+8 on Dec 24, 2024 at 10:00 AM
 ...
 * @example
 * // User in UTC+8
 * parseLocalDate("2024-12-24"); // Dec 24, 2024 00:00:00 local time
...
/**
 * Format 24-hour time string (HH:MM) as 12-hour time with AM/PM
 *
 ...
 *
 * @example
 * // User in UTC+8 on Dec 24, 2024 at 2:00 AM
 ...
 *
 * @param dateStr - Date string in YYYY-MM-DD format
 * @returns True if dateStr matches today's local date
 */
...
/**
 * Check if a date string is in the future (after today) in local timezone
 *
 * @param dateStr - Date string in YYYY-MM-DD format
 * @returns True if dateStr is after today
 */
...
/**
 * Format a date for display (e.g., "December 24, 2024")
 *
 * @param dateStr - Date string in YYYY-MM-DD format
...
/**
 * Format a date for short display (e.g., "Dec 24, 2024")
 *
 * @param dateStr - Date string in YYYY-MM-DD format
