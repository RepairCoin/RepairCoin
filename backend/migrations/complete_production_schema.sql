...
-- ============================================
-- Additional Updates Not in Base Schema
-- ============================================

-- ETH payment method (from 016_add_eth_payment_method.sql)
ALTER TABLE shops 
...
-- Customer RCN sources population (from 019_populate_customer_rcn_sources.sql)
-- This should be run after initial data import if needed

-- Lifetime earnings fixes (from 020_fix_lifetime_earnings.sql)
-- Run after importing transaction data

-- Minting tracking (from add_minting_tracking_to_purchases.sql)
...
-- Shop deposits table (from create_shop_deposits_table.sql)
...
-- ============================================
-- Complete Production Schema Ready
-- ============================================
