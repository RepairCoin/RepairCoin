-- 233 — (renumbered from 231 to dodge main's 231_add_shop_linkedin) A/B testing for Auto-Messages (AI Campaigns Advanced, Phase 4).
--
...
-- A/B is mutually exclusive with drip sequences (mig 232) — enforced in the controller.
--
