...
// Mirror of backend/src/config/featureTiers.ts (and frontend/src/config/featureTiers.ts).
// Minimum tier per gated feature; empty until features are gated. Any feature absent here is
...
export const TIER_RANK: Record<ShopTier, number> = {
  free: 0,
  starter: 1,
  growth: 2,
  business: 3,
