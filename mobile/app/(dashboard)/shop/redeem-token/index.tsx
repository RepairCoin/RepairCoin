            ...
            <ScrollView showsVerticalScrollIndicator={false}>
                  ...
                  <View className="flex-row items-center justify-between">
                    <View className="flex-row items-center">
                      ...
                      <Text className="text-gray-400 text-sm">
                        {sessionStatus === "waiting" ? "Time Remaining" : "Processing Time"}
                      </Text>
                    </View>
              ...
              {sessionStatus === "processing" && (
                <View className="flex-row items-center justify-center py-4 mb-4">
                  <ActivityIndicator size="large" color="#FFCC00" style={{ marginRight: 12 }} />
            ...
            <View className="mt-4 space-y-3">
              {sessionStatus === "waiting" && (
                <View className="space-y-3 gap-4 mb-4">
                  ...
                  <TouchableOpacity
                    onPress={() => {
                      // Refresh status - in real implementation this would check API
                      Alert.alert("Info", "Status refreshed - still waiting for customer approval");
                    }}
