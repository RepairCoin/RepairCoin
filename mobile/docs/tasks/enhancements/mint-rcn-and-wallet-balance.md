...
|----------|---------|--------|
| `POST /tokens/mint-to-wallet` | Mint platform RCN to on-chain wallet | Check if exists |
| `GET /customers/:address` | Returns `currentRcnBalance` (platform) | Exists |
| RCN Contract `balanceOf()` | On-chain balance read | Exists (smart contract) |
...
| File | Change |
|------|--------|
| `mobile/feature/home/components/customer-wallet/index.tsx` | Add wallet balance display |
| `mobile/shared/services/token.services.ts` | Add `mintToWallet()` method (create if needed) |
| `mobile/feature/home/components/MintRCNModal.tsx` | Create mint modal component |
| `mobile/feature/home/hooks/useMintToWallet.ts` | Create mint mutation hook |
