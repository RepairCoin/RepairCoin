# Bug: Calendar Status Colors Inconsistent Between Views and Legends
...
| Status | Booking Calendar | Full Calendar | Web Calendar | Legend Shows |
|--------|-----------------|---------------|-------------|-------------|
| Paid | #FFCC00 (yellow) | #3b82f6 (blue) | #3b82f6 (blue) | N/A |
| Approved (paid+approved) | #10b981 (emerald) | #10b981 (emerald) | #3b82f6 (blue) | #3b82f6 (blue) |
| Completed | #22c55e (green) | #22c55e (green) | #22c55e (green) | #22c55e (green) |
| Cancelled | #ef4444 (red) | #ef4444 (red) | #ef4444 (red) | #ef4444 (red) |
| Expired | #f97316 (orange) | #f97316 (orange) | N/A | #f97316 (orange) |
...
| File | Change |
|------|--------|
| `mobile/shared/constants/booking-colors.ts` | Create new shared color mapping |
| `mobile/feature/booking/utils/statusUtils.ts` | Import from shared mapping |
| `mobile/feature/appointment/utils/statusUtils.ts` | Import from shared mapping |
| `mobile/feature/booking/components/BookingShopTab.tsx` | Use shared colors, fix legend |
| `mobile/feature/appointment/components/MonthlyCalendarView.tsx` | Use shared colors, fix legend |
| `mobile/feature/booking/components/EnhancedBookingCard.tsx` | Use shared colors |
