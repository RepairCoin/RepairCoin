# Bug: Pending Shop Sees Role Selection Instead of Pending Screen
...
| File | Change |
|------|--------|
| `mobile/shared/hooks/auth/useAuth.ts` | Fix field mapping and navigation logic |
| `mobile/shared/services/auth.services.ts` | Verify `checkUserExists` response mapping |
| `mobile/app/(auth)/register/pending.tsx` | Verify exists or create pending screen |
