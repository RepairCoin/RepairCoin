# Bug: New Booking Not Visible After Stripe Payment
...
| Source | Query Key | Matches? |
|--------|-----------|----------|
| Payment success invalidates | `["repaircoin", "bookings"]` | - |
| Bookings tab uses | `["repaircoin", "appointments", "my", ...]` | No |
...
| File | Change |
|------|--------|
| `mobile/app/(dashboard)/shared/payment-sucess/index.tsx` | Add appointments query invalidation |
