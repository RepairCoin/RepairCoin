# Bug: Reschedule Requests Screen Has No Navigation Entry Point
...
|-----------|------|--------|
| Screen route | `mobile/app/(dashboard)/shop/reschedule-requests/index.tsx` | Exists |
| Screen component | `mobile/feature/booking/screens/RescheduleRequestsScreen.tsx` | Exists |
| Approve/Reject mutations | `mobile/feature/booking/hooks/mutations/useRescheduleActions.ts` | Exists |
| Pending count query | `mobile/feature/booking/hooks/queries/useRescheduleQueries.ts` | Exists |
| Request cards UI | `mobile/feature/booking/components/RescheduleRequestCard.tsx` | Exists |
...
| File | Change |
|------|--------|
| `mobile/feature/booking/components/BookingShopTab.tsx` | Add reschedule requests button with badge |
| `mobile/feature/booking/hooks/queries/useRescheduleQueries.ts` | Verify pending count query exists |
