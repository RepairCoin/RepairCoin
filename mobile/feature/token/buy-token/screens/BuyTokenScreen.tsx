...
import { HowItWorksItem } from "@/feature/token/services/token.interface";
import {
  useBuyTokenQueries,
  usePurchaseUI,
  useBuyTokenUI,
...
export default function BuyTokenScreen() {
  ...
  const onPurchase = () => {
    handlePurchase(purchaseAmount, isQualified, isValidAmount, openSubscriptionModal);
  };
    ...
    <ThemedView className="flex-1">
      ...
      <View className="pt-14 pb-4 px-5">
        <View className="flex-row items-center justify-between">
          <TouchableOpacity onPress={navigateBack} className="p-2 -ml-2">
            <AntDesign name="arrowleft" color="white" size={24} />
          </TouchableOpacity>
          <Text className="text-white text-xl font-bold">Buy RCN Tokens</Text>
          <TouchableOpacity onPress={openHowItWorks} className="p-2 -mr-2">
      ...
      >
        <View className="flex-1 bg-black/80">
          <Pressable className="flex-1" onPress={closeHowItWorks} />
