        ...
        {metrics && (
          <View className="flex-row flex-wrap">
            ...
            <View className="w-1/2 pl-2">
              <View className="bg-[#1a1a1a] rounded-xl p-4">
                <Text className="text-gray-400 text-xs mb-1">Profit Margin</Text>
                <Text
                  className={`text-lg font-bold ${
                    metrics.averageProfitMargin >= 0 ? "text-green-400" : "text-red-400"
                  }`}
                >
            ...
            <>
              {currentChartConfig.isSingleLineWithColoredDots ? (
                <LineChart
                  ...
                  referenceLine1Config={{ color: "#6B7280", dashWidth: 5, dashGap: 5 }}
