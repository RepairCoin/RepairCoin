...
import { useShopEditProfile } from "@/feature/shop/hooks/ui";
import { PROFILE_COLORS } from "@/feature/shop/constants";
    ...
    <ThemedView className="h-full w-full">
      <View className="w-full h-full">
        ...
        >
          ...
          <FormInput
            label="X (Twitter)"
            icon={<Text style={{ fontSize: 18, fontWeight: 'bold', color: PROFILE_COLORS.primary }}>X</Text>}
